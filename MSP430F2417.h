...
#define SHT0_0               (0*0x100) /* ADC12 Sample Hold 0 Select Bit: 0 */
#define SHT0_1               (1*0x100) /* ADC12 Sample Hold 0 Select Bit: 1 */
#define SHT0_2               (2*0x100) /* ADC12 Sample Hold 0 Select Bit: 2 */
#define SHT0_3               (3*0x100) /* ADC12 Sample Hold 0 Select Bit: 3 */
#define SHT0_4               (4*0x100) /* ADC12 Sample Hold 0 Select Bit: 4 */
#define SHT0_5               (5*0x100) /* ADC12 Sample Hold 0 Select Bit: 5 */
#define SHT0_6               (6*0x100) /* ADC12 Sample Hold 0 Select Bit: 6 */
#define SHT0_7               (7*0x100) /* ADC12 Sample Hold 0 Select Bit: 7 */
#define SHT0_8               (8*0x100) /* ADC12 Sample Hold 0 Select Bit: 8 */
#define SHT0_9               (9*0x100) /* ADC12 Sample Hold 0 Select Bit: 9 */
#define SHT0_10             (10*0x100) /* ADC12 Sample Hold 0 Select Bit: 10 */
#define SHT0_11             (11*0x100) /* ADC12 Sample Hold 0 Select Bit: 11 */
#define SHT0_12             (12*0x100) /* ADC12 Sample Hold 0 Select Bit: 12 */
#define SHT0_13             (13*0x100) /* ADC12 Sample Hold 0 Select Bit: 13 */
#define SHT0_14             (14*0x100) /* ADC12 Sample Hold 0 Select Bit: 14 */
#define SHT0_15             (15*0x100) /* ADC12 Sample Hold 0 Select Bit: 15 */

#define SHT1_0               (0*0x1000) /* ADC12 Sample Hold 1 Select Bit: 0 */
#define SHT1_1               (1*0x1000) /* ADC12 Sample Hold 1 Select Bit: 1 */
#define SHT1_2               (2*0x1000) /* ADC12 Sample Hold 1 Select Bit: 2 */
#define SHT1_3               (3*0x1000) /* ADC12 Sample Hold 1 Select Bit: 3 */
#define SHT1_4               (4*0x1000) /* ADC12 Sample Hold 1 Select Bit: 4 */
#define SHT1_5               (5*0x1000) /* ADC12 Sample Hold 1 Select Bit: 5 */
#define SHT1_6               (6*0x1000) /* ADC12 Sample Hold 1 Select Bit: 6 */
#define SHT1_7               (7*0x1000) /* ADC12 Sample Hold 1 Select Bit: 7 */
#define SHT1_8               (8*0x1000) /* ADC12 Sample Hold 1 Select Bit: 8 */
#define SHT1_9               (9*0x1000) /* ADC12 Sample Hold 1 Select Bit: 9 */
#define SHT1_10             (10*0x1000) /* ADC12 Sample Hold 1 Select Bit: 10 */
#define SHT1_11             (11*0x1000) /* ADC12 Sample Hold 1 Select Bit: 11 */
#define SHT1_12             (12*0x1000) /* ADC12 Sample Hold 1 Select Bit: 12 */
#define SHT1_13             (13*0x1000) /* ADC12 Sample Hold 1 Select Bit: 13 */
#define SHT1_14             (14*0x1000) /* ADC12 Sample Hold 1 Select Bit: 14 */
#define SHT1_15             (15*0x1000) /* ADC12 Sample Hold 1 Select Bit: 15 */
...
#define CONSEQ_0             (0*2)      /* ADC12 Conversion Sequence Select: 0 */
#define CONSEQ_1             (1*2)      /* ADC12 Conversion Sequence Select: 1 */
#define CONSEQ_2             (2*2)      /* ADC12 Conversion Sequence Select: 2 */
#define CONSEQ_3             (3*2)      /* ADC12 Conversion Sequence Select: 3 */
...
#define SHS_0                (0*0x400)  /* ADC12 Sample/Hold Source: 0 */
#define SHS_1                (1*0x400)  /* ADC12 Sample/Hold Source: 1 */
#define SHS_2                (2*0x400)  /* ADC12 Sample/Hold Source: 2 */
#define SHS_3                (3*0x400)  /* ADC12 Sample/Hold Source: 3 */
#define CSTARTADD_0          (0*0x1000) /* ADC12 Conversion Start Address: 0 */
#define CSTARTADD_1          (1*0x1000) /* ADC12 Conversion Start Address: 1 */
#define CSTARTADD_2          (2*0x1000) /* ADC12 Conversion Start Address: 2 */
#define CSTARTADD_3          (3*0x1000) /* ADC12 Conversion Start Address: 3 */
#define CSTARTADD_4          (4*0x1000) /* ADC12 Conversion Start Address: 4 */
#define CSTARTADD_5          (5*0x1000) /* ADC12 Conversion Start Address: 5 */
#define CSTARTADD_6          (6*0x1000) /* ADC12 Conversion Start Address: 6 */
#define CSTARTADD_7          (7*0x1000) /* ADC12 Conversion Start Address: 7 */
#define CSTARTADD_8          (8*0x1000) /* ADC12 Conversion Start Address: 8 */
#define CSTARTADD_9          (9*0x1000) /* ADC12 Conversion Start Address: 9 */
#define CSTARTADD_10        (10*0x1000) /* ADC12 Conversion Start Address: 10 */
#define CSTARTADD_11        (11*0x1000) /* ADC12 Conversion Start Address: 11 */
#define CSTARTADD_12        (12*0x1000) /* ADC12 Conversion Start Address: 12 */
#define CSTARTADD_13        (13*0x1000) /* ADC12 Conversion Start Address: 13 */
#define CSTARTADD_14        (14*0x1000) /* ADC12 Conversion Start Address: 14 */
#define CSTARTADD_15        (15*0x1000) /* ADC12 Conversion Start Address: 15 */
...
#define SREF_0               (0*0x10)   /* ADC12 Select Reference 0 */
#define SREF_1               (1*0x10)   /* ADC12 Select Reference 1 */
#define SREF_2               (2*0x10)   /* ADC12 Select Reference 2 */
#define SREF_3               (3*0x10)   /* ADC12 Select Reference 3 */
#define SREF_4               (4*0x10)   /* ADC12 Select Reference 4 */
#define SREF_5               (5*0x10)   /* ADC12 Select Reference 5 */
#define SREF_6               (6*0x10)   /* ADC12 Select Reference 6 */
#define SREF_7               (7*0x10)   /* ADC12 Select Reference 7 */
...
const sfrb UCA0RXBUF      = UCA0RXBUF_;
...
const sfrb UCB0RXBUF      = UCB0RXBUF_;
...
const sfrb UCA1RXBUF      = UCA1RXBUF_;
...
const sfrb UCB1RXBUF      = UCB1RXBUF_;
...
const sfrw TLV_CHECKSUM      = TLV_CHECKSUM_;
#define TLV_DCO_30_TAG_        (0x10F6)  /* TLV TAG_DCO30 TAG */
const sfrb TLV_DCO_30_TAG    = TLV_DCO_30_TAG_;
#define TLV_DCO_30_LEN_        (0x10F7)  /* TLV TAG_DCO30 LEN */
const sfrb TLV_DCO_30_LEN    = TLV_DCO_30_LEN_;
#define TLV_ADC12_1_TAG_       (0x10DA)  /* TLV ADC12_1 TAG */
const sfrb TLV_ADC12_1_TAG   = TLV_ADC12_1_TAG_;
#define TLV_ADC12_1_LEN_       (0x10DB)  /* TLV ADC12_1 LEN */
const sfrb TLV_ADC12_1_LEN   = TLV_ADC12_1_LEN_;
#endif
...
#define RESERVED0_VECTOR    (0 * 2)  /* 0xFFC0 Reserved Int. Vector 0 */
#define RESERVED1_VECTOR    (1 * 2)  /* 0xFFC2 Reserved Int. Vector 1 */
#define RESERVED2_VECTOR    (2 * 2)  /* 0xFFC4 Reserved Int. Vector 2 */
#define RESERVED3_VECTOR    (3 * 2)  /* 0xFFC6 Reserved Int. Vector 3 */
#define RESERVED4_VECTOR    (4 * 2)  /* 0xFFC8 Reserved Int. Vector 4 */
#define RESERVED5_VECTOR    (5 * 2)  /* 0xFFCA Reserved Int. Vector 5 */
#define RESERVED6_VECTOR    (6 * 2)  /* 0xFFCC Reserved Int. Vector 6 */
#define RESERVED7_VECTOR    (7 * 2)  /* 0xFFCE Reserved Int. Vector 7 */
#define RESERVED8_VECTOR    (8 * 2)  /* 0xFFD0 Reserved Int. Vector 8 */
#define RESERVED9_VECTOR    (9 * 2)  /* 0xFFD2 Reserved Int. Vector 9 */
#define RESERVED10_VECTOR   (10 * 2) /* 0xFFD4 Reserved Int. Vector 10 */
#define RESERVED11_VECTOR   (11 * 2) /* 0xFFD6 Reserved Int. Vector 11 */
#define RESERVED12_VECTOR   (12 * 2) /* 0xFFD8 Reserved Int. Vector 12 */
#define RESERVED13_VECTOR   (13 * 2) /* 0xFFDA Reserved Int. Vector 13 */
#define RESERVED14_VECTOR   (14 * 2) /* 0xFFDC Reserved Int. Vector 14 */
#define RESERVED15_VECTOR   (15 * 2) /* 0xFFDE Reserved Int. Vector 15 */
#define USCIAB1TX_VECTOR    (16 * 2) /* 0xFFE0 USCI A1/B1 Transmit */
#define USCIAB1RX_VECTOR    (17 * 2) /* 0xFFE2 USCI A1/B1 Receive */
#define PORT1_VECTOR        (18 * 2) /* 0xFFE4 Port 1 */
#define PORT2_VECTOR        (19 * 2) /* 0xFFE6 Port 2 */
#define RESERVED20_VECTOR   (20 * 2) /* 0xFFE8 Reserved Int. Vector 20 */
#define ADC12_VECTOR        (21 * 2) /* 0xFFEA ADC */
#define USCIAB0TX_VECTOR    (22 * 2) /* 0xFFEC USCI A0/B0 Transmit */
#define USCIAB0RX_VECTOR    (23 * 2) /* 0xFFEE USCI A0/B0 Receive */
#define TIMERA1_VECTOR      (24 * 2) /* 0xFFF0 Timer A CC1-2, TA */
#define TIMERA0_VECTOR      (25 * 2) /* 0xFFF2 Timer A CC0 */
#define WDT_VECTOR          (26 * 2) /* 0xFFF4 Watchdog Timer */
#define COMPARATORA_VECTOR  (27 * 2) /* 0xFFF6 Comparator A */
#define TIMERB1_VECTOR      (28 * 2) /* 0xFFF8 Timer B CC1-6, TB */
#define TIMERB0_VECTOR      (29 * 2) /* 0xFFFA Timer B CC0 */
#define NMI_VECTOR          (30 * 2) /* 0xFFFC Non-maskable */
#define RESET_VECTOR        (31 * 2) /* 0xFFFE Reset [Highest Priority] */
